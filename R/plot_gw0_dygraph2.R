...
#' @param recurr Whether to search recursively within the `input_dir` or `pipe_house$d4_ipip_room`. Logical. Defaults to FALSE.
#' @param prompt Logical. Use a prompt to select stations for plotting? Defaults to FALSE.
#' @param pipe_house If the `pipe_house` is provided stationse will be searched for in the `pipe_house$d4_ipip_room` directory.
