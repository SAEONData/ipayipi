...
#' @param p Processing pipeline steps, each generated by [ipayipi::p_step()] parsed by [ipayipi::pdt()]. _See examples__.
...
#' @details This function assists with building a tabluar representation of a data processing pipeline. The table is fully evaluated, for example, by checking station parameters and time intervals, prior to performing processing functions within [ipayipi::dt_process()]. Once fully evaluated the function parameters (`f_params`) for processing data are stored in a station file. Once stored, partial evaluation is not necessary until the pipeline sequence requires updating (using the `overwrite_pipe_memory` argument of [dt_process()] and [dt_process_batch()]).
