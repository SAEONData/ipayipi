...
#' @param gaps Logical or vector of phenomena/string names. If TRUE then the station 'gaps', i.e. the 'gap' table will be joined to the aggregated table. If a vector of string/s is supplied then these are used to filter the gap table before joining this to aggregated data.
