...
#' @param pipe_house List of pipeline directories. __See__ [ipip_house()] __for details__.
...
#' # Notes:
#' * This function will process data from multiple stations where their raw-flat files are stored in the 'source_room'. 
...
logger_data_import_batch <- function(
  ...
  if (verbose || xtra_v) cli::cli_inform(c(
    ...
    "i" = paste0("If your import was incorrect check the pipe house",
      " \'source_room\' was defined correctly. And use \'wanted\' and",
