...
#' @param cores Number of cores to farm processing off to. This assists with increasing the speed of read-write capabilities dealing with chunks.
#' @keywords big data; data chunking; data indexing;
#' @export
