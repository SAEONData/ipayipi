...
#' @keywords data pipeline; transform data type.
...
phen_vars_sts <- function(
  ...
  phen_table <- phen_table[phen_name %in% phens][,
    c("phen_type", "phen_name", "units", "offset", "var_type"), with = FALSE]
