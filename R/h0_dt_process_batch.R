...
#'  - dt_flag(): _To develop_. Implementation of standardised flags. Options should include what type of flags (variance, spikes, thresholds etc. Generates flag tables that can be visualised in the pipeline.
#'
...
dt_process_batch <- function(
  ...
  station_files <- ipayipi::dta_list(
    input_dir = pipe_house$d4_ipip_room, file_ext = station_ext,
    prompt = prompt, recurr = FALSE,
