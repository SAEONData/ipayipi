...
#' @param cores Number of processing cores to use for writing data chunks, and checking intra chunk time-series integrity.
#' @keywords chunking index; internal function.
#' @export
