...
#' @param dtp_n The numeric (integer) order of the processing step.
#' @param f A string to be evaluated in the data.table environment.
#' @param input_dt The name of the input data table (character string).
